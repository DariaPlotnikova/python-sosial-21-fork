**Этот репозиторий является ответвлением от python-social-auth (0.2.21), в котором решена проблема получения state из сессии для корректной работы с Django=1.5.12**
